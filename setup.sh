...
sudo apt-get install -y libxft-dev libxinerama-dev libtiff5-dev

# Basic ROS package requirements
sudo apt install -y protobuf-compiler libb64-dev ros-humble-diagnostic-updater lsb-release wget gnupg 
