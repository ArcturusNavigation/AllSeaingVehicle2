...
#include "asv_interfaces/msg/goal_state.hpp"
...
class MessageSender : public rclcpp::Node {
    public:
        MessageSender() : Node("message_parser") {
            m_state_sub = this->create_subscription<asv_interfaces::msg::GoalState>(
    ...
    private:
        rclcpp::Subscription<asv_interfaces::msg::GoalState>::SharedPtr m_state_sub;
        rclcpp::Publisher<protobuf_client_interfaces::msg::Gateway>::SharedPtr m_gateway_pub;

        void state_callback(const asv_interfaces::msg::GoalState & msg) {
